export const COUNTRIES = {
  ...
  'France': { lat: 46.6034, lng: 1.8883, code: 'FR' },
...
export const ATTACK_TYPES = {
  DDoS: { color: '#ff3333', name: 'DDoS Attack' },
  'Brute Force': { color: '#ffff00', name: 'Brute Force' },
  'Port Scan': { color: '#00ccff', name: 'Port Scan' },
  'SQL Injection': { color: '#cc00ff', name: 'SQL Injection' },
  'Malware': { color: '#ff8800', name: 'Malware Distribution' }
};